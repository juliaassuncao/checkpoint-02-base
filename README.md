...
Abaixo estão alguns prints de um layout pronto para servir como inspiração.

Atenção: vocês não precisam copiar exatamente esse layout.  
A ideia é observar a organização visual, os espaçamentos, as cores, os cards, a tabela e o formulário.

### Header e Sobre o evento

![Print do layout completo](referencias/header-e-sobre.png)

### Área de atividades

![Print da área de atividades](referencias/atividades-e-programacao.png)

### Formulário

![Print do formulário](referencias/form-e-rodape.png)
